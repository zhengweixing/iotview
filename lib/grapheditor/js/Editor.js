...
Editor.prototype.getGraphXml = function(ignoreSelection)
{
	...
	if (bgimg != null) {
		...
		node.setAttribute('backgroundPosition', 'center');
...
{
	return [
		    {key: 'iphone', title: '827 * 1169', format: new mxRectangle(0, 0, 827, 1169)},
		    {key: 'm4', title: '1080 * 1761', format: new mxRectangle(0, 0, 1080, 1761)},
		    {key: 'm5', title: '800 * 450', format: new mxRectangle(0, 0, 800, 450)},
