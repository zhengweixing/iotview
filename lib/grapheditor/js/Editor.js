...
PageSetupDialog.getFormats = function () {
	return [
		{key: 'p1', title: '1920 * 1080', format: new mxRectangle(0, 0, 1920, 1080)},
		{key: 'p2', title: '1439 * 899', format: new mxRectangle(0, 0, 1439, 899)},
		{key: 'p3', title: '1024 * 768', format: new mxRectangle(0, 0, 1024, 768)},
		{key: 'p4', title: '800 * 450', format: new mxRectangle(0, 0, 800, 450)},
