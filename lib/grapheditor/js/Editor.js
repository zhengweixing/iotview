...
Editor.prototype.resetGraph = function()
{
	...
	this.graph.pageFormat = new mxRectangle(0, 0, 800, 450);
...
Editor.prototype.getGraphXml = function(ignoreSelection)
{
	...
	var bgimg = this.graph.backgroundImage;
	if (bgimg != null) {
		node.setAttribute('backgroundImage', bgimg.src);
		node.setAttribute('backgroundPosition', 'top');
		node.setAttribute('backgroundRepeat', 'no-repeat');
		node.setAttribute('background-size', bgimg.width + ' ' + bgimg.height);
	}
...
PageSetupDialog.getFormats = function () {
	return [
		{key: 'p1', title: '1920 x 1080', format: new mxRectangle(0, 0, 1920, 1080)},
		{key: 'p2', title: '1439 x 899', format: new mxRectangle(0, 0, 1439, 899)},
		{key: 'p3', title: '1024 x 768', format: new mxRectangle(0, 0, 1024, 768)},
		{key: 'p4', title: '1470 x 826', format: new mxRectangle(0, 0, 1470, 826)},
		{key: 'p5', title: '800 x 450', format: new mxRectangle(0, 0, 800, 450)},
		{key: 'p6', title: '390 x 840', format: new mxRectangle(0, 0, 390, 840)},
